...
const VideoTitle = ({title,overview}) => {
  return (
    <div className= "  w-screen aspect-video absolute pt-[10%] md:pt-[12%] px-4 md:px-24 text-white bg-gradient-to-tr from-black mg-10">
      <h1 className=' text-lg md:text-4xl font-bold'>{title}</h1>
      <p className='hidden md:block py-3 w-[40%]'>{overview}</p>
